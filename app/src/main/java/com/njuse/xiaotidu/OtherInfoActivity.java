...
public class OtherInfoActivity extends AppCompatActivity{
    ...
    private void initWidget() {
        backToEmailInput = findViewById(com.njuse.xiaotidu.R.id.back_to_email_input);
        phoneNum = findViewById(com.njuse.xiaotidu.R.id.phone_number_edittext);
        password = findViewById(com.njuse.xiaotidu.R.id.password_edittext);
        passwordConfirm = findViewById(com.njuse.xiaotidu.R.id.password_confirm_edittext);
        register = findViewById(com.njuse.xiaotidu.R.id.register_button);
        showPassword = findViewById(com.njuse.xiaotidu.R.id.show_password_checkbox);
