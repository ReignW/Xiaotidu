...
public class PasswordStyle {
    public static String getPasswordStyle(String password) {
        String passwordStyle =
                "<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">\n" +
                        ...
                        "<tr>\n" +
                        "\n" +
                        "<td align=\"left\" valign=\"top\" style=\"font-size:14px; color:#7b7b7b; line-height: 25px; font-family:Hiragino Sans GB; padding: 20px 0px 20px 0px\">你正在请求找回密码，以下是该账号的登录密码，请妥善保管，勿泄露给他人。 如非你本人操作，请忽略此邮件。\n" +
                        "\n" +
                        "</td>\n" +
                        "</tr>\n" +
                        "<tr>\n" +
                        ...
                        "<tbody><tr>\n" +
                        "<td>\n" +
                        "<span style=\"font-family:Hiragino Sans GB;\"><div style=\"padding:10px 18px 10px 18px;border-radius:3px;text-align:center;text-decoration:none;background-color:#ecf4fb;color:#4581E9;font-size:20px; font-weight:700; letter-spacing:2px; margin:0;white-space:nowrap\">" + password + "\n" +
                        "</div>\n" +
                        "</span>\n" +
                        "</td>\n" +
                        "</tr>\n" +
